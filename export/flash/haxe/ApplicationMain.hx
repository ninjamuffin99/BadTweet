...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/gameTHumbnail.png");
		...
		urls.push ("assets/images/twitterPic.jpg");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/music/LSDAIM.mp3");
		...
		urls.push ("assets/sounds/keyEnter.mp3");
		types.push (lime.Assets.AssetType.MUSIC);
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 480, 720, "000000");
		#end
		#else
		create ();
		#end
