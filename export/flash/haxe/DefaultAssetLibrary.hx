...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/gameTHumbnail.png", __ASSET__assets_images_gamethumbnail_png);
		type.set ("assets/images/gameTHumbnail.png", AssetType.IMAGE);
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		className.set ("assets/images/twitterPic.jpg", __ASSET__assets_images_twitterpic_jpg);
		type.set ("assets/images/twitterPic.jpg", AssetType.IMAGE);
		className.set ("assets/music/LSDAIM.mp3", __ASSET__assets_music_lsdaim_mp3);
		type.set ("assets/music/LSDAIM.mp3", AssetType.MUSIC);
		...
		className.set ("assets/sounds/keyEnter.mp3", __ASSET__assets_sounds_keyenter_mp3);
		type.set ("assets/sounds/keyEnter.mp3", AssetType.MUSIC);
		...
		id = "assets/images/gameTHumbnail.png";
		path.set (id, id);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/twitterPic.jpg";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/music/LSDAIM.mp3";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_gamethumbnail_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_twitterpic_jpg extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_music_lsdaim_mp3 extends flash.media.Sound { }
...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_keyenter_mp3 extends flash.media.Sound { }
...
@:image("assets/images/gameTHumbnail.png") #if display private #end class __ASSET__assets_images_gamethumbnail_png extends lime.graphics.Image {}
@:file("assets/images/images-go-here.txt") #if display private #end class __ASSET__assets_images_images_go_here_txt extends lime.utils.Bytes {}
@:image("assets/images/twitterPic.jpg") #if display private #end class __ASSET__assets_images_twitterpic_jpg extends lime.graphics.Image {}
@:file("assets/music/LSDAIM.mp3") #if display private #end class __ASSET__assets_music_lsdaim_mp3 extends lime.utils.Bytes {}
...
@:file("assets/sounds/keyEnter.mp3") #if display private #end class __ASSET__assets_sounds_keyenter_mp3 extends lime.utils.Bytes {}
